...
function main() {
  ...
  for (const file of LOTS) {
    ...
    if (process.env.DBG) { console.log('DBG rutting:', JSON.stringify(lot.rows.rutting)); console.log('DBG perf:', JSON.stringify(lot.rows.performance)); console.log('DBG FR:', Object.keys(values).filter(k=>/Rutting/.test(k))); console.log('DBG QA01:', JSON.stringify(lot.records.QA01.values)); }
